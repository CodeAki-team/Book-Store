...
const Heroslider = () => {
  ...
  return (
    <section
      className={`relative w-full max-w-7xl mx-auto flex flex-col md:flex-row bg-white shadow-xl overflow-hidden rounded-2xl transition-opacity duration-1000 ease-in-out ${
    ...
    >
      ...
      <div className="w-full md:w-1/2 p-12 flex flex-col justify-center bg-white z-10 relative">
        ...
        <p className="text-gray-700 text-xl mb-6">
          Dive into a world of stories. INKSPIRE is your go-to online bookstore,
          offering a curated collection for every reader.
        </p>
      ...
      <div className="w-full md:w-1/2 relative h-[400px] overflow-hidden">
        <Image
          ...
          className={`object-cover rounded-r-2xl transition-opacity duration-500 ease-in-out ${
